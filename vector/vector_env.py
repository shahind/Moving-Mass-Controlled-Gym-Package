...
from mmcgym.vector.utils.spaces import batch_space

__all__ = ["VectorEnv"]


class VectorEnv(mmcgym.Env):
    ...
    observation_space : `mmcgym.spaces.Space` instance
        Observation space of a single environment.

    action_space : `mmcgym.spaces.Space` instance
