...
from mmcgym.spaces import Space, Tuple, Dict
from mmcgym.vector.utils.spaces import _BasemmcgymSpaces
...
def concatenate(items, out, space):
    ...
    if isinstance(space, _BasemmcgymSpaces):
        ...
        raise ValueError(
            "Space of type `{0}` is not a valid `mmcgym.Space` "
