...
from mmcgym.vector.vector_env import VectorEnv
from mmcgym.error import (
    AlreadyPendingCallError,
    NoAsyncCallError,
    ClosedEnvironmentError,
    CustomSpaceError,
)
from mmcgym.vector.utils import (
...
class AsyncVectorEnv(VectorEnv):
    ...
    observation_space : `mmcgym.spaces.Space` instance, optional
        Observation space of a single environment. If `None`, then the
        observation space of the first environment is taken.

    action_space : `mmcgym.spaces.Space` instance, optional
        ...
        if self.shared_memory:
            try:
                ...
                raise ValueError(
                    ...
                    "is incompatible with non-standard mmcgym observation spaces "
                    "(i.e. custom spaces inheriting from `mmcgym.Space`), and is "
                    "only compatible with default mmcgym spaces (e.g. `Box`, "
