...
from mmcgym.vector.async_vector_env import AsyncVectorEnv
from mmcgym.vector.sync_vector_env import SyncVectorEnv
from mmcgym.vector.vector_env import VectorEnv, VectorEnvWrapper
...
def make(id, num_envs=1, asynchronous=True, wrappers=None, **kwargs):
    ...
    Returns
    -------
    env : `mmcgym.vector.VectorEnv` instance
        The vectorized environment.

    Example
    -------
    >>> import mmcgym
    >>> env = mmcgym.vector.make('CartPole-v1', 3)
    >>> env.reset()
    array([[-0.04456399,  0.04653909,  0.01326909, -0.02099827],
          ...
          dtype=float32)
    """
    from mmcgym.envs import make as make_
