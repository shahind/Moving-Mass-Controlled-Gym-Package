...
from mmcgym.spaces import Discrete
from mmcgym.spaces import MultiDiscrete
from mmcgym.spaces import MultiBinary
from mmcgym.spaces import Tuple
from mmcgym.spaces import Dict
...
def flatdim(space):
    ...
    the space is not defined in ``mmcgym.spaces``.
    """
