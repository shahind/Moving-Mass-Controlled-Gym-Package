...
class Space(object):
    ...
    `sample()` method), and batching functions (in `mmcgym.vector.VectorEnv`), are
    only well-defined for instances of spaces provided in mmcgym by default.
    ...
    def __setstate__(self, state):
        ...
        # See:
        #   https://github.com/openai/mmcgym/pull/2397 -- shape
        #   https://github.com/openai/mmcgym/pull/1913 -- np_random
        #
        if "shape" in state:
